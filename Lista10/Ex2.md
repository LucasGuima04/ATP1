...
c) Ao se referir a um elemento do array, o número da posição contido dentro dos parênteses é um indice.
d) Os nomes dos cinco elementos do array p são p[0],p[1], p[2],p[3],p[4].
e) O conteúdo de um elemento em particular de um array é chamado valor desse elemento.
f) Dar nome a um array, indicar seu tipo e especificar o número de elementos contidos nele é chamado declarar o array.
...
i) O nome do elemento do array d na linha 3, coluna 5 é d[3][5].